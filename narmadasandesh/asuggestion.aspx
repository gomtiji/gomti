<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="asuggestion.aspx.cs" Inherits="ahome" %>
...
<div class="container gallery fadeIn animated">
        ...
        <div class="container">
            ...
            <h2 class="title-style-1">Manage Suggestion<span class="title-under"></span></h2>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataTextField="uploadfile" HeaderText="File" 
                            DataNavigateUrlFields="uploadfile" DataNavigateUrlFormatString="~/file/{0}" 
                            Target="_blank" />
