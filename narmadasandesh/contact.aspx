<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="suggestion" %>
				...
				Your valuable suggestion are welcomed always, to make Narmada Sandesh better.
					...
					<form action="php/mail.php" class="contact-form ajax-form">
						...
						<div class="row">
							...
							<div class="form-group col-md-6">
	                            <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="Message*"  required TextMode="MultiLine" Rows="5"></asp:TextBox>
	                        </div>
