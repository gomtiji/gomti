...
public partial class suggestion : System.Web.UI.Page
{
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        string k = "insert into suggestion values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + FileUpload1.FileName + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
        ...
        TextBox3.Text = "";
        TextBox4.Text = "";
        Label1.Text = "Thank You ! Your Suggestion Successfully Send....";
        cn.Close();
    }
}